...
#  ======= train stem-mix as per MT3 ======= #
HYDRA_FULL_ERROR=1 OMP_NUM_THREADS=1 python3 train.py \
    --config-path="config" \
    --config-name="config_slakh_stemmix_v1" \
    devices=[0,1] \
    hydra/job_logging=disabled \
    model="MT3Net" \
    dataset="SlakhStemMix" \
    split_frame_length=2000 \
    eval.eval_after_num_epoch=60 \
    eval.eval_first_n_examples=3 \
    eval.eval_per_epoch=10 \
    eval.contiguous_inference=False \
    path="../../../outputs/2025-03-12/11-07-04/MT3Net_SlakhStemMix/version_0/checkpoints/last.ckpt" \
    # path="../../../outputs/2025-01-03/21-46-49/MT3Net_SlakhStemMix/version_0/checkpoints/last.ckpt" \
    # path="../../../outputs/2025-01-01/09-26-03/MT3Net_SlakhStemMix/version_0/checkpoints/last.ckpt" \
