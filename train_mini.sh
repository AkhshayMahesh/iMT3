...
# ======= train segmem with prev_frame, prev_augment, context = N on MINI DATASET ======= #
# This uses the new CTE loss and reduced dataset

echo "Starting training on mini 20-file dataset with CTE loss..."
